...
def parse_args():
    ...
    parser.add_argument("--config", default='/home/cosmo/code/cia-ssd/CIA-SSD/examples/second/configs/kitti_car_vfev3_spmiddlefhd_rpn1_mghead_syncbn.py', help="train config file path")
